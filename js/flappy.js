...
if (!canvas) {
  console.error('Canvas #game ikke fundet. Sørg for at scriptet er indlæst med defer eller efter HTML-elementet.');
}
...
// Use Image() without constructor args and set src relative to the HTML page (html/)
const assets = {
  fish: new Image(),
  top: new Image(),
  bottom: new Image(),
